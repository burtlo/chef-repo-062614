...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "franklin999-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/franklin999"
  #   chef.validation_client_name = "franklin999-validator"
  #   chef.validation_key_path = ".chef/franklin999-validator.pem"
  # end
end
